...
describe('Controller: LoginCtrl', function () {
  ...
  beforeEach(inject(function ($q, $controller, $rootScope, $httpBackend) {
      q = $q,
        rootScope = $rootScope,
        scope = rootScope.$new();
      $httpBackend.whenGET('app/account/login/login.html')
        .respond(200);
...
//This is success
  it('should have a LoginCtrl controller', function () {
    ...
    //expect('neo4jApp.LoginCtrl').toBeDefined();
  });
  ...
  xdescribe('Function:signUp', function () {
  ...
  xdescribe('Function:forgotPassword', function () {
